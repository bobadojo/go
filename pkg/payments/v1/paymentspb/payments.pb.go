...
const file_bobadojo_payments_v1_payments_proto_rawDesc = "" +
	"\n" +
	"#bobadojo/payments/v1/payments.proto\x12\x14bobadojo.payments.v1Bi\n" +
	"\x18com.bobadojo.payments.v1B\rPaymentsProtoP\x01Z<github.com/bobadojo/go/pkg/payments/v1/paymentspb;paymentspbb\x06proto3"
...
func file_bobadojo_payments_v1_payments_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_bobadojo_payments_v1_payments_proto_rawDesc), len(file_bobadojo_payments_v1_payments_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
